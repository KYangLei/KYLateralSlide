...
class LeftViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func configSubviews() {
        ...
        header.image = UIImage.init(named: "2.JPG")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            DispatchQueue.main.async {
                self.ky_sidePresentViewController(viewController: PresentViewController())
            }
            break
        case 1:
            DispatchQueue.main.async {
                self.ky_sidePushViewController(viewController: PresentViewController())
            }
            break
        default:
            break
